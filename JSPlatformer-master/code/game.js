...
/*
Mob.prototype.act = function(step, level) {
	this.speed.y += step * gravity;
	var motion = new Vector(this.speed.y * step);
...
var wobbleSpeed = 6, wobbleDist = 0.1;
...
//var wobbleSpeedMob = 2.5, wobbleDistMob = .8;
...
Mob.prototype.moveY = function(step, level) {
...
Level.prototype.mobTouched = function(type, actor) {
	if (type == "lava")
		//console.log("fubar");
